      ...
      <div className="flex min-h-screen w-full !max-w-none">
        <Sidebar variant="inset" collapsible="icon">
          ...
          <SidebarContent>
            ...
            {/* Se removieron secciones de Reportes/Estadísticas no usadas */}
              ...
              <SidebarGroup>
                ...
                <SidebarGroupContent>
                  <SidebarMenu>
                    ...
                    {/* Menú de Materias removido si no se utiliza en navegación */}
        ...
        <div className="flex-1 flex flex-col overflow-hidden w-full !max-w-none">
          <header className="h-14 border-b flex items-center justify-between px-4 md:px-6 sticky top-0 bg-background z-10 w-full">
            ...
            <div className="flex items-center gap-2">
              ...
              {/* Acciones rápidas removidas si están duplicadas con búsqueda o sidebar */}
