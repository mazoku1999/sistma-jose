...
interface AssignAulaWizardProps {
  isOpen: boolean
  onClose: () => void
  onSuccess: () => void
...
export default function AssignAulaWizard({
  isOpen,
  onClose,
  onSuccess,
  currentGestionId,
  profesorId,
  profesorName
}: AssignAulaWizardProps) {
  const { toast } = useToast()

  console.log("AssignAulaWizard - profesorId recibido:", profesorId, "profesorName:", profesorName)
  ...
  const checkCombination = async () => {
    try {
      ...
      if (response.ok) {
        ...
        // Mantener todos los cursos disponibles
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Usar el endpoint de aulas original con id_profesor
                ...
                <Card className="p-6 bg-gradient-to-br from-green-50 to-emerald-50 border-green-200">
                  ...
                  <div className="grid md:grid-cols-2 gap-4 text-sm">
                    <div className="space-y-2">
                      <div>
                        <span className="font-medium text-green-700">Profesor:</span>
                        <p className="text-green-800">{profesorName}</p>
                      </div>
                      <div>
