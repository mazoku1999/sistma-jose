...
import { getGradeRange, getRangeColorClass } from "@/lib/grade-utils"
...
export default function NotasPage() {
    ...
    const getNotaColor = (nota: number) => {
        if (nota >= 85) return "text-green-600 bg-green-50" // DP
        if (nota >= 69) return "text-blue-600 bg-blue-50"  // DO
        if (nota >= 51) return "text-yellow-600 bg-yellow-50" // DA
        return "text-red-600 bg-red-50" // ED
    }

    const getNotaLabel = (nota: number) => {
        if (nota >= 85) return "DP"
        if (nota >= 69) return "DO"
        if (nota >= 51) return "DA"
        return "ED"
    }
    ...
    const getEstadisticasNotas = () => {
        ...
        const aprobados = notasValidas.filter(n => n.promedio_final_trimestre >= 51).length
        ...
        <div className="space-y-6">
            ...
            {trimestreGlobal && (
                <>
                                            ...
                                            const renderCell = (t: number, valor: number) => {
                                                ...
                                                if (editable) {
                                                    return (
                                                        <div className="flex flex-col items-center gap-1">
                                                            ...
                                                            />
                                                            <span className="text-[10px] text-muted-foreground">/ 100 ({getNotaLabel(valor)})</span>
                                                        </div>
                                                    )
                                                }
                                                ...
                                                return (
                                                    <div className="flex flex-col items-center gap-1">
                                                        ...
                                                        />
                                                        <span className="text-[10px] text-muted-foreground">/ 100 ({getNotaLabel(shown)})</span>
                                                    </div>
                                                )
                                            }
                    ...
                    <Card>
                        <CardHeader>
                            <CardTitle className="text-lg">Rangos valorativos (Bolivia)</CardTitle>
                            <CardDescription>Escala oficial: ED, DA, DO, DP</CardDescription>
                        </CardHeader>
                        <CardContent>
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                <div className="flex items-center gap-2">
                                    <div className="w-4 h-4 rounded bg-red-500"></div>
                                    <span className="text-sm">ED: 1 - 50 (En Desarrollo)</span>
                                </div>
                                <div className="flex items-center gap-2">
                                    <div className="w-4 h-4 rounded bg-yellow-500"></div>
                                    <span className="text-sm">DA: 51 - 68 (Desarrollo Aceptable)</span>
                                </div>
                                <div className="flex items-center gap-2">
                                    <div className="w-4 h-4 rounded bg-blue-500"></div>
                                    <span className="text-sm">DO: 69 - 84 (Desarrollo Óptimo)</span>
                                </div>
                                <div className="flex items-center gap-2">
                                    <div className="w-4 h-4 rounded bg-green-500"></div>
                                    <span className="text-sm">DP: 85 - 100 (Desarrollo Pleno)</span>
                                </div>
                            </div>
                        </CardContent>
                    </Card>
